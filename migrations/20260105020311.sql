...
COMMENT ON COLUMN "resource"."code" IS '编码';
...
-- Create index "idx_resource_action_sort" to table: "resource_action"
CREATE UNIQUE INDEX "idx_resource_action_sort" ON "resource_action" ("sort");
...
-- Create index "idx_role_sort" to table: "role"
CREATE UNIQUE INDEX "idx_role_sort" ON "role" ("sort");
