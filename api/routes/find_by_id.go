...
func (x *Controller) FindById(ctx context.Context, c *app.RequestContext) {
	...
	data, err := x.RoutesX.FindById(ctx, user, dto)
	if err != nil {
...
func (x *Service) FindById(ctx context.Context, user *common.IAMUser, dto common.FindByIdDto) (data model.Route, err error) {
	return
}
