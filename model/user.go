...
type FeishuUserData struct {
	...
	ExpiresIn        uint64 `bson:"expires_in" json:"-"`
	Name             string `bson:"name" json:"name"`
	...
	UnionId          string `bson:"union_id" json:"-"`
	Email            string `bson:"email" json:"-"`
	EnterpriseEmail  string `bson:"enterprise_email" json:"-"`
	UserId           string `bson:"user_id" json:"-"`
	Mobile           string `bson:"mobile" json:"-"`
	TenantKey        string `bson:"tenant_key" json:"-"`
	RefreshExpiresIn uint64 `bson:"refresh_expires_in" json:"-"`
