...
type Resource struct {
	...
	Acls       []Acl     `gorm:"many2many:resource_acl_rel;foreignKey:acl_key;References:Key;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
}

type ResourceAclRel struct {
	ResourceID uint64 `gorm:"primaryKey"`
	AclKey     string `gorm:"primaryKey;type:varchar(20)"`
