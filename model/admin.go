...
type Admin struct {
	...
	UUID       uuid.UUID  `gorm:"type:uuid;default:uuid_generate_v4();comment:用户唯一标识" json:"uuid"`
	...
	Roles      []Role     `gorm:"many2many:admin_role_rel;references:Code;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
	Resources  []Resource `gorm:"many2many:admin_resource_rel;references:Path;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
}
