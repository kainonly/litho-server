...
type Role struct {
	...
	OrgID       string    `gorm:"column:org_id;type:bigint;not null;index;uniqueIndex:idx_role_org_name,priority:1;comment:所属组织ID"` // 所属组织ID
	...
	Name        string    `gorm:"column:name;type:text;not null;uniqueIndex:idx_role_org_name,priority:2;comment:权限名称"` // 权限名称
