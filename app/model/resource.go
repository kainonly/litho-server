...
type Resource struct {
	ID         uint64
	AccessKey  string `gorm:"size:200;unique;not null;comment:resource access control key"`
	ParentKey  string `gorm:"size:200;not null;default:origin;comment:parent node"`
